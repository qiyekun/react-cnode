...
const TopicItem = (({ topic, onClick }) => {//eslint-disable-line
  return (
...
class UserInfo extends React.Component {
  ...
  render() {
    ...
    const topics = appState.user.detail.recentTopics
    const replies = appState.user.detail.recentReplies
    const collections = appState.user.collections.list
    return (
      <UserWrapper>
